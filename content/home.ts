...
export const home = {
  ...
  fr: {
    ...
    communities:[{name:'GDG on Campus 42 Paris',tag:'Organiser et partager',text:'Je co-organise le chapitre. En tant que co-lead, j’ai mené un talk sur Gemini avec Laurent Picard, de Google : plus de 100 participants (juillet 2026).',url:'https://gdg.community.dev/gdg-on-campus-42-paris-paris-france/'},{name:'Fitness 42',tag:'S’entraîner et encourager',text:'Coach depuis plus de 3 ans, l’un des trois coachs d’une communauté de plus de 300 membres : plus de 15 séances de fitness données, 15 à 20 personnes par séance en moyenne.',url:''},{name:'CITOY.ENS',tag:'Écouter et questionner',text:'Des conférences et des débats. J’assiste aux rencontres et j’ai proposé des intervenants à l’association.',url:'https://citoyens-website.cdn.dgnum.eu/'}],
