...
export const home = {
  en: {
    ...
    communities:[{name:'GDG on Campus 42 Paris',tag:'Organise & share',text:'I co-organise the chapter. As co-lead, I ran a talk on Gemini with Laurent Picard from Google: 100+ attendees (July 2026).',url:'https://gdg.community.dev/gdg-on-campus-42-paris-paris-france/'},{name:'Fitness 42',tag:'Train & encourage',text:'3+ years leading and coaching: 15+ calisthenics sessions led, 20+ people each time.',url:''},{name:'CITOY.ENS',tag:'Listen & question',text:'Conferences and debates. I attend talks and have suggested speakers to the association.',url:'https://citoyens-website.cdn.dgnum.eu/'}],
  ...
  fr: {
    ...
    communities:[{name:'GDG on Campus 42 Paris',tag:'Organiser et partager',text:'Je co-organise le chapitre. En tant que co-lead, j’ai mené un talk sur Gemini avec Laurent Picard, de Google : plus de 100 participants (juillet 2026).',url:'https://gdg.community.dev/gdg-on-campus-42-paris-paris-france/'},{name:'Fitness 42',tag:'S’entraîner et encourager',text:'3+ ans d’animation et de coaching : plus de 15 séances de callisthénie encadrées, plus de 20 personnes à chaque fois.',url:''},{name:'CITOY.ENS',tag:'Écouter et questionner',text:'Des conférences et des débats. J’assiste aux rencontres et j’ai proposé des intervenants à l’association.',url:'https://citoyens-website.cdn.dgnum.eu/'}],
